...
{   // debug($_POST);
    ...
    values ('$_POST[id_produit]', '$_POST[reference]', '$_POST[categorie]', '$_POST[titre]', '$_POST[description]', '$_POST[couleur]', '$_POST[taille]', '$_POST[public]',  '$photo_bdd',  '$_POST[prix]',  '$_POST[stock]')");    $contenu .= '<div class="validation">Le produit a été ajouté</div>';
}
//--- LIENS PRODUITS ---//
...
if(isset($_GET['action']) && ($_GET['action'] == 'ajout' || $_GET['action'] == 'modification')){
    ...
    <form class="form-control form-control-sm" method="post" enctype="multipart/form-data" action="">
...
<input type="text" id="couleur" name="couleur" placeholder="la couleur du produit"  value="'; if(isset($produit_actuel['couleur'])) echo $produit_actuel['couleur']; echo '"> <br><br>
        ...
        <label  for="taille">Taille</label><br>
         <select class="form-select form-select-sm" name="taille">
        ...
        <input type="submit" class="btn btn-outline-info value="'; echo ucfirst($_GET['action']) . ' du produit">
    </form>';
}
